...
export default function LoginPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (validateForm()) {
      // Call login to set authenticated state
      login();
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Log in to your Zyntrix account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-sm text-[#6A0DAD] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/register" className="text-[#6A0DAD] font-semibold hover:underline">
                Sign up
              </Link>
            </p>
          </div>
